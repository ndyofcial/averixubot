...
async def _(client, message):
    ...
    total_blocks = 7   # panjang bar
    loop_count = 1     # berapa kali muter animasi
    ...
    msg = await message.reply("▱" * total_blocks)
    ...
    try:
        ...
        if chat_id in blacklist:
            txt = f"""
</b> ɢʀᴏᴜᴘ {message.chat.title} sᴜᴅᴀʜ ᴀᴅᴀ ᴅɪ ᴅᴀʟᴀᴍ ʙʟᴀᴄᴋʟɪsᴛ ❌
"""
        else:
            await add_to_vars(client.me.id, "BL_ID", chat_id)
            txt = f"""
</b> ɢʀᴏᴜᴘ {message.chat.title} ʙᴇʀʜᴀsɪʟ ᴅɪ ᴛᴀᴍʙᴀʜᴋᴀɴ ᴋᴇ ʙʟᴀᴄᴋʟɪsᴛ ✅
"""
...
async def _(client, message):
    ...
    try:
        ...
        if chat_id not in blacklist:
            response = f"""
<b> ɢʀᴏᴜᴘ {message.chat.title} ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴅᴀʟᴀᴍ ʙʟᴀᴄᴋʟɪꜱᴛ ɪᴅɪᴏᴛ
"""
        else:
            await remove_from_vars(client.me.id, "BL_ID", chat_id)
            response = f"""
<b> ɢʀᴏᴜᴘ {message.chat.title} ʙᴇʀʜᴀꜱɪʟ ᴅɪ ʜᴀᴘᴜꜱ ᴅᴀʀɪ ʙʟᴀᴄᴋʟɪꜱᴛ
"""
